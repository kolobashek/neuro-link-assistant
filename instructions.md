...
| **✅ Пройдено** | 401 | ✅ Успешно | 70.7% |
| **❌ Провалено** | 127 | 🚨 Требует исправления | 22.4% |
...
|-----------|--------|--------|-------------------|
| **system/** | 10 тестов | 🟡 Частично работают | Selenium, ErrorHandler |
| **db/** | 10 тестов | 🟢 Работают | PostgreSQL пароль |
| **integration/** | 4 теста | 🟢 Работают | Исправлены SQLAlchemy типы |
...
#### 3.4.1. 🔥 Компонент ErrorHandler не зарегистрирован
```
ERROR: KeyError: "Компонент с именем 'ErrorHandler' не зарегистрирован"
```
**Блокирует:** 10 интеграционных тестов
**Приоритет:** КРИТИЧЕСКИЙ

**Примеры ошибок:**
- `tests/integration/core/test_core_components_integration.py`
- `tests/integration/core/test_plugin_system_integration.py`
...
**Отсутствующие файлы:**
- `core/common/process/` - базовые классы созданы, но не импортируются
...
```
**Блокирует:** Тесты миграций
**Приоритет:** ВЫСОКИЙ

**Затронутые тесты:**
- `tests/db/test_migrations.py`
- Некоторые интеграционные тесты БД
...
|---------|---------|------|-------------|
| **Прохождение тестов** | 70.7% (401/567) | 85%+ (480+/567) | 🔥 Критично |
| **Критические ошибки** | 26 | 0 | 🔥 Критично |
| **Покрытие кода** | 14% | 25%+ | 🟡 Важно |
| **Время выполнения** | 29 мин | <20 мин | 🟢 Желательно |
