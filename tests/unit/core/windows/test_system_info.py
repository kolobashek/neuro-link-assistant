...
class TestSystemInfo:
    ...
    def test_get_os_info_basic(self, mock_arch, mock_release, mock_version, mock_system, system_info):
    ...
    @patch('platform.release', return_value='10')
    @patch('platform.architecture', return_value=('64bit', ''))
    def test_get_os_info_with_wmi(self, mock_arch, mock_release, mock_version, mock_system, system_info):
    ...
    @patch('psutil.cpu_percent', return_value=25.0)
    @patch('psutil.cpu_freq')
    def test_get_cpu_info_with_wmi(self, mock_cpu_freq, mock_cpu_percent, mock_cpu_count, system_info):
