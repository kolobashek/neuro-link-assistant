...
class TestBrowserInitialization:
    ...
    def test_initialize_firefox(
        self, mock_gecko_driver_manager, mock_firefox_options, mock_service, mock_webdriver
    ):
    ...
    def test_initialize_edge(
        self, mock_edge_driver_manager, mock_edge_options, mock_service, mock_webdriver
    ):
