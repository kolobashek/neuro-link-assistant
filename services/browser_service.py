...
def fallback_browser_method(text):
    ...
    speak_text(
        "Открыт браузер с DeepSeek. Запрос скопирован в буфер обмена. Вставьте его и получите"
        " ответ."
    )

    return (
        "Открыт браузер с DeepSeek. Запрос скопирован в буфер обмена. Пожалуйста, вставьте его и"
        " получите ответ."
    )
