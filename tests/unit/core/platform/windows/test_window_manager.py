...
class TestWindowManager:
        ...
        with patch("win32gui.GetWindowText", return_value="Test Window"):
            ...
            with patch("win32gui.IsWindowVisible", return_value=True):
                ...
                with patch(
                    ...
                    side_effect=lambda hwnd: {1001: "TestClass", 1002: "AnotherClass"}.get(
                        hwnd, ""
                    ),
                ):
                    # Настраиваем мок для GetWindowRect
    ...
    def test_find_window_by_process(
        self, mock_process, mock_get_process_id, mock_enum_windows, window_manager
    ):
        ...
        mock_get_process_id.side_effect = lambda hwnd: (0, {1001: 2001, 1002: 2002}.get(hwnd, 0))
    ...
    def test_get_all_windows(self, mock_enum_windows, window_manager):
        ...
        with patch(
            "win32gui.GetWindowText",
            side_effect=lambda hwnd: {1001: "Window 1", 1002: "Window 2", 1003: ""}.get(hwnd, ""),
        ):
            # Настраиваем мок для IsWindowVisible
            with patch("win32gui.IsWindowVisible", return_value=True):
                # Настраиваем мок для GetClassName
